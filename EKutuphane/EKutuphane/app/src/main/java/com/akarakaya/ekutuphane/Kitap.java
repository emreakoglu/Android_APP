...
public class Kitap {
	...
	public Kitap(int id, int kutuphid,String kutuphane_adi,String kitap_adi, int sayfa_sayisi, String ozellik, String yazarlari, String isbn, int adet,
			int suanki_adet, String ekitap_path) {
		super();
		this.id = id;
		this.kutuphid = kutuphid;
		this.kutuphane_adi = kutuphane_adi;
	...
	public String getKutuphane_adi() {
		return kutuphane_adi;
	}

	public void setKutuphane_adi(String kutuphane_adi) {
		this.kutuphane_adi = kutuphane_adi;
	}
