...
public class AESCrypt {
     ...
     *
     *
     * @param key used to generated key
    ...
    public static String decrypt(final String password, String base64EncodedCipherText)
        ...
        try {
            ...
            byte[] decryptedBytes = decrypt(password, decodedCipherText);
     ...
     */
    public static byte[] encrypt(final String key,final byte[] message)
    ...
    public static byte[] decrypt(final String key,final byte[] decodedCipherText)
            throws GeneralSecurityException, UnsupportedEncodingException {
        SecretKeySpec keySpec = generateKey(key);
        final Cipher cipher = Cipher.getInstance(AES_MODE);
        IvParameterSpec ivSpec = new IvParameterSpec(ivBytes);
